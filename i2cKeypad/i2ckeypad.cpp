 ...
 *
 *  Modified to work with different version of Wire.h/cpp and
 *  with an Adafruit 3x4 Phone-style Matrix keypad
 *
 *  Secondary source from Angel Sancho <angelitodeb@gmail.com>
 *
 ...
 *  Default mapping is for the adafruit 3x4 phone-style matrix keypad
 */
#define COL0  0
#define COL1  1
#define COL2  2
